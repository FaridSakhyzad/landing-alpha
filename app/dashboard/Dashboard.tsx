      ...
      <section className={pageStyles.section}>
        ...
        <div className={styles.dashboard}>
          ...
          <div className={styles.dashboardImageBox}>
            ...
            <div className={`${styles.dashboardImageContainer} slide${activeAccItemIdx}`}>
              <div className={`${styles.dashboardImage} ${styles.dashboardImage1}`} />
              <div className={`${styles.dashboardImage} ${styles.dashboardImage2}`} />
              <div className={`${styles.dashboardImage} ${styles.dashboardImage3}`} />
              <div className={`${styles.dashboardImage} ${styles.dashboardImage4}`} />
            </div>
          </div>
        </div>
      </section>
