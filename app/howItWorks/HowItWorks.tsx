    ...
    <div className="container" id="features">
      <section className={pageStyles.section}>
        ...
        <div className={styles.howItWorks}>
          <div className={styles.howItWorksImageBox}>
            <svg width="596" height="559" viewBox="0 0 596 559" xmlns="http://www.w3.org/2000/svg" className={styles.howItWorksImageBg}>
          ...
          <div className={styles.howItWorksMoreCol}>
            <div className={styles.howItWorksMoreItems}>
              <div className={styles.howItWorksMoreItem}>
                <img className={styles.howItWorksMoreItemImage} src="/pic--avatar-1.jpg" alt="" />
              </div>
              <div className={styles.howItWorksMoreItem}>
                <img className={styles.howItWorksMoreItemImage} src="/pic--avatar-2.jpg" alt="" />
              </div>
              <div className={styles.howItWorksMoreItem}>
                <img className={styles.howItWorksMoreItemImage} src="/pic--avatar-3.jpg" alt="" />
              </div>
              <div className={styles.howItWorksMoreItem}>
                <img className={styles.howItWorksMoreItemImage} src="/pic--avatar-1.jpg" alt="" />
              </div>
